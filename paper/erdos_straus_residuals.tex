...
\item A reciprocity principle (Theorem~\ref{thm:J}) collapsing the
  ...
  mechanism of correlated failure and of the record prime.
...
\item A machine-checked (Lean~4/mathlib) verification of the elementary
  ...
  Theorem~\ref{thm:J} --- in the accompanying repository.
\end{itemize}
...
single global statement about $p$ --- the structural explanation of
...
static record --- now has a mechanism attached.
