...
\item A machine-checked (Lean~4/mathlib) verification of the elementary
  ...
  checks of Lemma~\ref{lem:S} at $R = 19$ and $23$, and the proved
  discrete-log bridges carrying each enumeration into the
  multiplicative model --- in the accompanying repository.
\end{itemize}
...
exactly its enumeration's single evaluator axiom. Every declaration
