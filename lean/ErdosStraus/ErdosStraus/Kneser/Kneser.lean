...
VENDORED (unmodified except this note and the `MiscYD.AddCombi.Kneser.MulStab`
→ `ErdosStraus.Kneser.MulStab` import path) from
https://github.com/YaelDillies/misc-yd, file
`MiscYD/AddCombi/Kneser/Kneser.lean`,
commit 3c3f6d2ef31dd82c82ea90fb0fef8508c976afb7 (2026-07-14), Apache 2.0.
Vendored because mathlib does not yet contain Kneser's addition theorem;
used by `ErdosStraus/TheoremS.lean` for the paper's Theorem 1.10(i).
-/
module
...
public import ErdosStraus.Kneser.MulStab
