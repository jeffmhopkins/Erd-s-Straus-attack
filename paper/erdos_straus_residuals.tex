...
\hypersetup{pdftitle={Residual certificates for the Erdos-Straus
  ...
  bounds, and computations to 10\textasciicircum 12},
...
$1{,}175{,}215{,}396$
hard primes below $10^{12}$, where a five-decade-old record breaks:
the largest minimal residual is $111$, first attained at
$p = 119{,}945{,}383{,}009$.
\end{abstract}
...
$R_{\min}$: for every hard prime through $10^{12}$ by explicit
...
\item Computed and verified residual certificates for all
  $1{,}175{,}215{,}396$ hard primes below $10^{12}$, with a
  calibrated model that predicted, in advance, both the filling of an
  empty band and the decade in which the five-decade-old record
  $R = 107$ would fall --- it fell at $R = 111$
...
prime below $10^{12}$. Bradford's range gives $R_{\min}(p) \ll p$;
...
all hard primes below $10^{12}$ and calibrate the base-case constant and
...
\section{Computations to \texorpdfstring{$10^{12}$}{10\textasciicircum 12}}\label{sec:comp}
...
the break of the five-decade record $R = 107$ at $R = 111$.}
\label{fig:hist}
\end{figure}

Three features of the distribution deserve comment.\nopagebreak
\begin{itemize}
\item \textbf{The record broke at $10^{12}$.} From $10^7$ to
  $10^{11}$ the maximal minimal residual stood at $R = 107$,
  attained by the single prime $8{,}803{,}369 < 10^7$ and unmoved
  across five decades. At $10^{12}$ it is
  ...
  primes in the same decade. In the
...
\item \textbf{A prediction, and what it was worth.} The \emph{calibrated
  ...
  a band that was empty at the time and the decade in which a
  five-decade-old record would fall.
