...
**Date:** 2026-08-02 (current through PR #28; this revision adds
...
| Theorem B (empirical covering) | unnumbered remark after Thm. 1.12 |
| Theorem C | not carried into the paper |
| Theorem D (density reduction) | Theorem 1.12 (`thm:D`) |
| Theorems E/F/G/G′/H (the chain) | the single Theorem 1.10 (`thm:FG`) |
| Theorem I (aggregate families) | Proposition 1.11 (`prop:agg`) |
| Theorem J (reciprocity) | Theorem 1.7 (`thm:J`) |
| Theorem K (conditional) | sketch inside Open Problem 5 |
| Theorem A‴ (R = 15, composite) | Theorem 1.5 (`thm:R15`) |
| Lemma S (support bound) | Lemma 1.8 (`lem:S`) |
| Theorem S (unconditional support bound, Kneser) | Theorem 1.9 (`thm:S`) |
...
31/10; see the proof of Theorem 1.10 there.)
