...
prime residual is a computable function of finite data (a
meta-theorem), yielding exact criteria at $R = 3, 7, 11$ and a
reciprocity identity
$\smash{\legendre{q}{R}} = \smash{\legendre{p}{q}}$ that governs how
failures correlate across residuals. The criteria feed an
unconditional chain of sieve bounds --- exceptional sets
$O(x/(\log x)^{\kappa})$ with $\kappa$ up to $19/2$ --- weaker in
