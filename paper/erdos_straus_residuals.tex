...
Computationally we exhibit certificates for all $128{,}671{,}219$
...
(Theorems~\ref{thm:FG}--\ref{thm:D}). The computations of
...
Thm.~\ref{thm:D} & Prop.~\ref{prop:succ} + Fundamental Lemma & \S\ref{sec:sieve} & no \\
\bottomrule
\end{tabular}
...
The full test suite (\texttt{python -m pytest}; $53$ tests) exercises the
